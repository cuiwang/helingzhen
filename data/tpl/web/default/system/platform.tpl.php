...
<div id="js-system-platform" ng-controller="SystemPlatform" ng-cloak>
	...
	<table class="table we7-table table-hover table-form  we7-form">
		...
		<tr>
			...
			<td>
				<span><?php  echo $url['host'];?><?php  echo $url['path'];?>web/index.php?c=account&a=auth&do=test</span>
			</td>
		...
		<tr>
			...
			<td>
				<span><?php  echo $url['host'];?><?php  echo $url['path'];?>web/index.php?c=account&a=auth&do=ticket</span>
			</td>
		...
		<tr>
			...
			<td>
				<input type="text" readonly value="<?php  echo $url['host'];?><?php  echo $url['path'];?>api.php?appid=/$APPID$" class="form-control">
			</td>
...
<script type="text/javascript">
	angular.module('accountApp').value('config', {
		...
		url: <?php echo !empty($url) ? json_encode($url) : 'null'?>,
		links: {
