						...
						if( blocks[i].data('value')!=chars[i] ){
							if( !_typeCompare(blocks[i].data('value'),chars[i]) ){
								...
								switch( chars[i] ){
									...
									case ' ':blocks[i].addClass('xdsoft_space xdsoft_digit2').removeClass('xdsoft_digit');break;
									case ':':blocks[i].addClass('xdsoft_space xdsoft_digit3').removeClass('xdsoft_digit');break;
									case '.':blocks[i].addClass('xdsoft_space xdsoft_digit4').removeClass('xdsoft_digit');break;
								}
							}
							if( !isNaN(chars[i]) ){
