...
require 'wechat_payment.inc.php';
load()->app('common');
load()->app('template');
...
if($this->module['config']['switch_fwpay'] == 2){
	$params['fw_appid'] = $this->module['config']['fw_appid'];
	$params['fw_mch_id'] = $this->module['config']['fw_mch_id'];
	$params['fw_api'] = $this->module['config']['fw_api'];
	$params['ty_sub_mch_id'] = $this->module['config']['ty_sub_mch_id'];
	$params['ty_appid'] = $this->module['config']['ty_appid'];
}
