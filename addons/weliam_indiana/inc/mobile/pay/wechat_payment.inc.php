...
function wechat_build($params, $wechat) {
	...
	if ($wechat['version'] == 1) {
	    ...
	    $service_appid = $params['fw_appid'];
	    $service_mchid = $params['fw_mch_id'];
		$wechat['signkey'] = $params['fw_api'];
		$package['appid'] = $service_appid;
		$package['mch_id'] = $service_mchid;
		$package['sub_appid'] = $params['ty_appid'];
		$package['sub_mch_id'] = $params['ty_sub_mch_id'];
		$package['sub_openid'] = $_W['fans']['from_user'];
