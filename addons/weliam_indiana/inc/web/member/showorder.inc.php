...
if ($operation == 'display') {
	...
	switch($type){
		case  'share': $condition_type =  " and type=0";break;
		case  'speech': $condition_type =  " and type=1";break;
		default : $condition_type =  " ";break;
	}
	
	$sql = "select  * from " . tablename('weliam_indiana_showprize') . " where $condition $condition_type  ORDER BY createtime asc " . "LIMIT " . ($pindex - 1) * $psize . ',' . $psize;
