...
function(a) {
	...
	function b(a, c) {
		...
		var f;
		if (c = c || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = c.touchBoundary || 10, this.layer = a, this.tapDelay = c.tapDelay || 200, this.tapTimeout = c.tapTimeout || 700, !b.notNeeded(a)) {
	...
	b.prototype.needsClick = function(a) {
		...
		if (this.cancelNextClick = !1, this.lastClickTime = b.timeStamp, h = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, g && (k = b.changedTouches[0], l = document.elementFromPoint(k.pageX - window.pageXOffset, k.pageY - window.pageYOffset) || l, l.fastClickScrollParent = this.targetElement.fastClickScrollParent), i = l.tagName.toLowerCase(), "label" === i) {
			...
			for (var m = l; m && "BODY" !== m.tagName.toUpperCase();) "LABEL" === m.tagName.toUpperCase() && a(m).find("input").click(), m = m.parentNode
		}
	...
	var b, c = !1,
		d = function(d) {
			...
			k.params = d, k.initialized = !1, k.inline = k.params.container ? !0 : !1, k.isH = "horizontal" === k.params.direction;
			var m = k.isH && c ? -1 : 1;
	...
	a.notification = a.noti = function(e) {
		e = a.extend({}, c, e), b = a(".notification"), b[0] || (b = a('<div class="notification"></div>').appendTo(document.body), k(b)), b.off("noti-click"), e.onClick && b.on("noti-click", function() {
			e.onClick(e.data)
		}), b.html(a.t7.compile(e.tpl)(e)), b.show(), b.addClass("notification-in"), b.data("params", e);
		var f = function() {
		...
		function c(b) {
			if (m && e[0] && !b.f7PreventPanelSwipe) {
				...
				if (l) {
					...
					return 300 > h && ("to-left" === v && ("right" === f && a.openPanel(f), "left" === f && e.hasClass("active") && a.closePanel()), "to-right" === v && ("left" === f && a.openPanel(f), "right" === f && e.hasClass("active") && a.closePanel())), m = !1, void(n = !1)
				}
				n || (u = e.hasClass("panel-cover") ? "cover" : "reveal", s || (e.show(), w.show()), t = e[0].offsetWidth, e.transition(0)), n = !0, b.preventDefault();
				var i = s ? 0 : -k;
				"right" === f && (i = -i), q = d - x.x + i, "right" === f ? (r = q - (s ? t : 0), r > 0 && (r = 0), -t > r && (r = -t)) : (r = q + (s ? t : 0), 0 > r && (r = 0), r > t && (r = t)), "reveal" === u ? (y.transform("translate3d(" + r + "px,0,0)").transition(0), w.transform("translate3d(" + r + "px,0,0)")) : e.transform("translate3d(" + r + "px,0,0)").transition(0)
			}
		}
	...
	var b = function() {
		this.state = sessionStorage, this.state.setItem("stateid", parseInt(this.state.getItem("stateid") || 1) + 1), this.state.setItem("currentStateID", this.state.getItem("stateid")), this.stack = sessionStorage, this.stack.setItem("back", "[]"), this.stack.setItem("forward", "[]"), this.extras = {}, this.init(), this.xhr = null
	};
	b.prototype.defaults = {
		...
		var f = b;
		void 0 === c && (c = !this.defaults.transition), "string" == typeof b && (f = {
			url: b,
			noAnimation: c,
			replace: d
		});
		var b = f.url,
			c = f.noAnimation,
			d = f.replace;
		this.getPage(b, function(f, g) {
			var h = this.getCurrentPage(),
				i = h[0].id,
				j = "pushBack";
			d && (j = "replaceBack"), e && (j = "reloadBack"), this[j]({
				url: location.href,
				pageid: "#" + i,
			...
			for (var k = JSON.parse(this.state.getItem("forward") || "[]"), l = this, m = 0; m < k.length; m++) a(k[m].pageid).each(function() {
				...
				if (b.data("page-remote")) {
					...
					c && c.remove(), l.extras[b[0].id] = void 0, b.remove()
				}
			});
			this.state.setItem("forward", "[]");
			var n = a("#" + a(f)[0].id);
			f.insertBefore(a(".page")[0]), n[0] !== f[0] && n.remove(), g && (l.extras[f[0].id] = g.appendTo(document.body));
			var o = this.genStateID();
			this.setCurrentStateID(o), this[d || e ? "replaceState" : "pushState"](b, o), this.forwardStack = [], this.animatePages(this.getCurrentPage(), f, null, c)
		})
		...
		this.xhr = a.ajax({
			...
			success: a.proxy(function(a, b, d) {
				var e = this.parseXHR(d),
					f = e[0],
					g = e[1];
				f[0].id || (f[0].id = this.genRandomID()), f.data("page-remote", 1), c.apply(this, [f, g])
			}, this),
			error: function() {
	...
	}, b.prototype.reloadBack = function(a) {}, b.prototype.popForward = function() {
		...
		if (a.smConfig.router) {
			...
			c.defaults = b.prototype.defaults, a(document).on("click", "a", function(b) {
				...
				if (!(d.hasClass("external") || d[0].hasAttribute("external") || d.hasClass("tab-link") || d.hasClass("open-popup") || d.hasClass("open-panel"))) {
					...
					var filterResult = customClickFilter(d);
		            if (!filterResult) {
		                return;
		            }
				}
    ...
    function customClickFilter($link) {
        var customRouterFilter = a.smConfig.routerFilter;
        if (a.isFunction(customRouterFilter)) {
