...
foreach ($list as $key => $value) {
    if ($value['default_jump'] == 1) {
        ...
        $url = $this->createMobileUrl('waplist', array('storeid' => $value['id'], 'mode' => 2), true);
    } elseif ($value['default_jump'] == 3) {
        $url = $this->createMobileUrl('waplist', array('storeid' => $value['id'], 'mode' => 4), true);
    } elseif ($value['default_jump'] == 4) {
        $url = $this->createMobileUrl('queue', array('storeid' => $value['id']), true);
    } elseif ($value['default_jump'] == 5) {
        $url = $this->createMobileUrl('reservationIndex', array('storeid' => $value['id'], 'mode' => 3), true);
