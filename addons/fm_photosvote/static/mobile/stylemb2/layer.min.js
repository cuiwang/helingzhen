...
function(a, b) {
    ...
    h.pt.space = function(a) {
        ...
        d.closeBtn[1] && (n += '<a class="xubox_close xubox_close' + d.closeBtn[0] + '" href="javascript:;" style="' + (4 === d.type ? "position:absolute; right:-3px; _right:7px; top:-4px;": "") + '"><img src="../addons/fm_photosvote/static/mobile/stylemb2/i10.png" width="30px" height="30px;" /></a>');
