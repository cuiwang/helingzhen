(function (e) {
    function t() {
        function t() {
            var e = R.createImage(appName + "/Public/Images/shaobing/home.png"),
                t = e.width,
                n = e.height;
        ...
        function n() {
        	//$('#ruleDiv').hide(),e("#guidePanel").hide(),e("#gameBtns").hide(), b.init(), b.start()
        	$('#ruleDiv').hide(),e("#guidePanel").hide(),e("#gameBtns").hide(),$("#resultPanel").hide(), b.init(), b.start()
        }
        t(), R.loadImage(h.gameImg, function () {
        	$(".gameBtns-wrap").show();
        	e(".tryagain").on("click", function () {
            	
        		n(), $('.topnWrap').hide()
            })
            e("#startGame").on("touchstart", function () {
    ...
    var r = {},
        ...
        l, c, h = {
            loadImg: [appName + "/Public/Images/shaobing/home.png", appName + "/Public/Images/shaobing/xiaomifeng10.png"],
            gameImg: [appName + "/Public/Images/shaobing/xiaomifeng9.png", appName + "/Public/Images/shaobing/xiaomifeng8.png", appName + "/Public/Images/shaobing/xiaomifeng2.png", appName + "/Public/Images/shaobing/xiaomifeng3.png", appName + "/Public/Images/shaobing/t0180d607c54cbc42bb.png", appName + "/Public/Images/shaobing/t0112104234e3d91aa4.png"]
        },
        p = function () {
            function t() {
                var t = Math.random(),
        ...
        d = function () {
            ...
            return n.init = function () {
                n.x, n.y, n.lastX, n.lastY, n.status = !0, n.model = R.createImage(appName + "/Public/Images/shaobing/xiaomifeng9.png"), n.model2 = R.createImage(appName + "/Public/Images/shaobing/xiaomifeng8.png"), n.width = l / 480 * n.model.width, n.height = n.width / n.model.width * n.model.height
        ...
        v = function () {
            function e(e) {
                ...
                var t = [appName + "/Public/Images/shaobing/xiaomifeng2.png", appName + "/Public/Images/shaobing/xiaomifeng3.png"];
            ...
            var t = e("#resultPanel"),
                n = function () {
                    ...
                    f && (n = "touchstart"), t.find(".replay").on(n, function () { 
                        //b.init(), b.start(),$("#windowlogin").hide()
                       playre(); //在玩 重来
                    ...
                    }), t.find(".lottery.lottery1").on(n, function () {
                        y.open()
                    })*/
                },
                r = {
                    show: function () {
                        ...
                        var e = 1,
                            n = b.score;
                        n === 0 ? e = 1 : n < 2 ? e = 2 : n < 4 ? e = 3 : n < 6 ? e = 4 : n < 8 ? e = 5 : e = 6;
                        // var r = t.find("#scoreBoard").show().find(".score-" + e);
                        // y.hide(), t.find("#scoreBoard .score-result").hide(), r.show(), e < 3 ? t.find("#scoreBoard .rank").show() : (t.find("#scoreBoard .rank").hide(), y.preLoad()), r.find(".tips span").html(n)//,alert(document.getElementById('score').innerHTML)
                        //var resultStr = n === 0 ? '你木有抓到一支小蜜蜂~哦~' : '哇噢，成功抓到<span>' + n + '</span>支小蜜蜂~！';
                        var resultStr = cfg_game_end_say.replace('(*)', n);
                        
                        //alert(resultStr);
                        var r = t.find("#scoreBoard .score-result");
                        r.find(".tips").html(resultStr);
                        ...
                        if (parseInt(n) > 0) {
                            ...
                            $.ajax({
                        		...
                        		success : function(ret) {
                        			if(ret.status != 'ng'){
                        				window.shareData.tContent = cfg_wx_share_desc1.replace('(*)', n);
                        				shareFn(window.shareData.tContent);
                        				// 判断是否显示礼盒
                        				showFlag = ret.status;
                                        $('.switch-show').hide();
                                        if (showFlag <= 0) {
                                        	...
                                        	$('#scoreOk').show();
                                        	r.find(".tips").html(resultStr + '，获得礼包一个！打开看看吧！');
                                        } else if (showFlag == 2) {
                                        	$('#prizeDiv').show();
                                        }
                                        //alert(showFlag);
                        ...
                        //y.hide(),t.find("#scoreBoard").show(),r.show(),$('#need_login').val() == '1' ? loginbox() : '',saveScore() //,alert(document.getElementById('score').innerHTML)
                        y.hide(),t.find("#scoreBoard").show(),r.show(),$('#need_login').val() == '1' ? loginbox() : ''
            ...
            var t = null,
                ...
                r, i = {
                    preLoad: function () {
                        ...
                        var r = ["http://game.misifu.cn/game/xiaomifeng/t0119206eb84a47a0ea.png", "http://game.misifu.cn/game/xiaomifeng/t01ce25d6a523c61246.png"],
                            i;
    ...
    var b = new Best.Game({
            ...
            score: 0,
            time: 0,
            bgImg: R.createImage(appName + "/Public/Images/shaobing/game_bg.png"),
            bgScrollTime: 0,
    ...
    (function () {
        var t = new Best.Scene({
            ...
            }, handleInput: function () {}, render: function () {}
        });
        w[t.id] = t
