...
/**
 */
class activity_exchange
{
    public $table = 'activity_exchange';
    ...
    public function getAvilibal(){
        global $_W;
        $sql = "SELECT * FROM ".tablename($this->table)." WHERE uniacid = :uniacid AND status=:status AND starttime <:starttime AND endtime>:endtime";
        $params = array(':uniacid'=>$_W['uniacid'],':status'=>1,':starttime'=>time(),':endtime'=>time());
