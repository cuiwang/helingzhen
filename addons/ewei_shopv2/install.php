...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_abonus_billo`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_abonus_billo` (
  ...
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_abonus_billp`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_abonus_billp` (
  ...
  KEY `idx_billid` (`billid`) USING BTREE,
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_abonus_level`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_abonus_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_adv`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9 ;DROP TABLE IF EXISTS `ims_ewei_shop_area_config`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_area_config` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_article`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='营销文章' AUTO_INCREMENT=15 ;DROP TABLE IF EXISTS `ims_ewei_shop_article_category`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='营销表单分类' AUTO_INCREMENT=12 ;DROP TABLE IF EXISTS `ims_ewei_shop_article_comment`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_article_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article_log` (
  ...
  KEY `idx_openid` (`openid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='点赞/阅读记录' AUTO_INCREMENT=621 ;DROP TABLE IF EXISTS `ims_ewei_shop_article_report`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article_report` (
  ...
  `uniacid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户举报记录' AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_article_share`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article_share` (
  ...
  KEY `idx_aid` (`aid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用户分享数据' AUTO_INCREMENT=63 ;DROP TABLE IF EXISTS `ims_ewei_shop_article_sys`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article_sys` (
  ...
  KEY `idx_article_keyword` (`article_keyword`),
  KEY `idx_article_title` (`article_title`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='文章设置';DROP TABLE IF EXISTS `ims_ewei_shop_author_bill`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_author_bill` (
  ...
  KEY `idx_week` (`week`) USING BTREE,
  KEY `idx_year` (`year`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_author_billo`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_author_billo` (
  ...
  KEY `idx_billid` (`billid`) USING BTREE,
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_author_billp`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_author_billp` (
  ...
  KEY `idx_billid` (`billid`) USING BTREE,
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_author_level`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_author_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_author_team`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_author_team_pay`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_banner`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_banner` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;DROP TABLE IF EXISTS `ims_ewei_shop_bargain_account`;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_bargain_actor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_bargain_goods`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_bargain_record`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_bargain_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_carrier`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_carrier` (
  ...
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_cashier_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_clearing`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_goods`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_goods_category`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_operator`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_order`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_cashier_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_pay_log`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_pay_log_goods`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_cashier_pay_log_goods` (
  ...
  KEY `cashierid` (`cashierid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_qrcode`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_cashier_qrcode` (
  ...
  KEY `uniacid` (`uniacid`) USING BTREE,
  KEY `cashierid` (`cashierid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_cashier_user`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_cashier_user` (
  ...
  KEY `username` (`username`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_category`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1174 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_apply`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_bank`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_commission_bank` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_clickcount`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=301 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_level`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_commission_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_commission_log` (
  ...
  KEY `idx_mid` (`mid`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_rank`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_commission_rank` (
  ...
  `content` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_repurchase`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_commission_repurchase` (
  ...
  KEY `openid` (`openid`),
  KEY `uniacid` (`uniacid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_commission_shop`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_commission_shop` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_mid` (`mid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=51 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon` (
  ...
  KEY `idx_catid` (`catid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_category` (
  ...
  KEY `idx_displayorder` (`displayorder`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_data`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_goodsendtask`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_goodsendtask` (
  ...
  `status` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_guess`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_guess` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_couponid` (`couponid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_log`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_sendshow`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_sendshow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_sendtasks`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_sendtasks` (
  ...
  `status` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_taskdata`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_taskdata` (
  ...
  `sendpoint` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_coupon_usesendtasks`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_coupon_usesendtasks` (
  ...
  `status` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_adv` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_category` (
  ...
  KEY `idx_displayorder` (`displayorder`),
  KEY `idx_enabled` (`enabled`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_comment`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_comment` (
  ...
  `merchid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_goods`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=20 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_log` (
  ...
  `merchid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=54 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_option`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_option` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_spec`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_spec` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_spec_item`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_spec_item` (
  ...
  `virtual` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_creditshop_verify`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_verify` (
  ...
  `merchid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_customer`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_customer` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_customer_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_customer_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_customer_guestbook`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_customer_guestbook` (
  ...
  `deleted` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_customer_robot`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_customer_robot` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_cate` (`cate`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_designer`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_designer_menu`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_designer_menu` (
  ...
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_dispatch`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_dispatch` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;DROP TABLE IF EXISTS `ims_ewei_shop_diyform_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diyform_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_diyform_data`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diyform_data` (
  ...
  KEY `idx_cid` (`cid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_diyform_temp`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diyform_temp` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_cid` (`cid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;DROP TABLE IF EXISTS `ims_ewei_shop_diyform_type`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diyform_type` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_cate` (`cate`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;DROP TABLE IF EXISTS `ims_ewei_shop_diypage`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diypage` (
  ...
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=19 ;DROP TABLE IF EXISTS `ims_ewei_shop_diypage_menu`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diypage_menu` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_lastedittime` (`lastedittime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;DROP TABLE IF EXISTS `ims_ewei_shop_diypage_plu`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_diypage_template`;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_diypage_template_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_exchange_cart`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exchange_cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exchange_code`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exchange_code` (
  ...
  PRIMARY KEY (`id`,`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exchange_group`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exchange_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exchange_query`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exchange_record`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exchange_record` (
  ...
  PRIMARY KEY (`id`,`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exchange_setting`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exhelper_express`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exhelper_express` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_isdefault` (`isdefault`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exhelper_senduser`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exhelper_senduser` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_isdefault` (`isdefault`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_exhelper_sys`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_exhelper_sys` (
  ...
  `merchid` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_express`;
...
(91, '安能物流', 'annengwuliu', 1, 0, '');DROP TABLE IF EXISTS `ims_ewei_shop_express_cache`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_feedback`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_form`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_form` (
  ...
  `cate` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_form_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_form_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_fullback_goods`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_fullback_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_fullback_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_fullback_log` (
  ...
  `goodsid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_funbar`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_funbar` (
  ...
  `uniacid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_gift`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_gift` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_globonus_bill`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_globonus_bill` (
  ...
  KEY `idx_week` (`week`),
  KEY `idx_year` (`year`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_globonus_billo`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_globonus_billo` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_globonus_billp`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_globonus_billp` (
  ...
  KEY `idx_billid` (`billid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_globonus_level`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_globonus_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=199 ;DROP TABLE IF EXISTS `ims_ewei_shop_goodscode_good`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goodscode_good` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_cards`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_cards` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_comment`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_comment` (
  ...
  KEY `idx_openid` (`openid`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_group`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_group` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_enabled` (`enabled`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_label`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_label` (
  ...
  `displayorder` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_labelstyle`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_labelstyle` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `style` int(3) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_option`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_option` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=405 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_param`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_param` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1110 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_spec`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_spec` (
  ...
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=93 ;DROP TABLE IF EXISTS `ims_ewei_shop_goods_spec_item`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_spec_item` (
  ...
  KEY `idx_show` (`show`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=291 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_adv` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_category` (
  ...
  KEY `idx_displayorder` (`displayorder`),
  KEY `idx_enabled` (`enabled`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_goods`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_goods` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_goods_atlas`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_goods_atlas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `g_id` int(11) NOT NULL,
  `thumb` varchar(145) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_order`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_order_refund`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_order_refund` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_paylog`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_set`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_set` (
  ...
  `headsdiscount` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_groups_verify`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_groups_verify` (
  ...
  `verifytime` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_invitation`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_invitation` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_type` (`type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_invitation_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_invitation_log` (
  ...
  KEY `idx_openid` (`openid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_invitation_qr`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_invitation_qr` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_adv`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_live_category` (
  ...
  KEY `idx_displayorder` (`displayorder`) USING BTREE,
  KEY `idx_enabled` (`enabled`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_coupon`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_favorite`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_goods`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_live_goods` (
  ...
  `maxliveprice` decimal(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_goods_option`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_live_goods_option` (
  ...
  `liveprice` decimal(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_setting`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_status`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_live_status` (
  ...
  `endtime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_live_view`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_live_view` (
  ...
  KEY `idx_uniacid` (`uniacid`) USING BTREE,
  KEY `idx_roomid` (`roomid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_lottery`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_lottery_default`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_lottery_default` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_lottery_join`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_lottery_join` (
  ...
  `addtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_lottery_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_lottery_log` (
  ...
  `addtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_mc_merchant`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_mc_merchant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;DROP TABLE IF EXISTS `ims_ewei_shop_member`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member` (
  ...
  KEY `idx_level` (`level`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2188 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_address`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_address` (
  ...
  KEY `idx_isdefault` (`isdefault`),
  KEY `idx_deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=83 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_cart`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_cart` (
  ...
  KEY `idx_openid` (`openid`),
  KEY `idx_deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=63 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_favorite`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_favorite` (
  ...
  KEY `idx_deleted` (`deleted`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=26 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_group`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `groupname` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_history`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_history` (
  ...
  KEY `idx_deleted` (`deleted`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2234 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_level`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_log` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=106 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_mergelog`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_message_template`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_message_template` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=26 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_message_template_default`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_message_template_default` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_message_template_type`;
...
(26, '兑换中心余额充值通知', 'exchange_recharge', 'OPENTM207727673', '', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 0, 'exchange', '兑换中心消息通知');DROP TABLE IF EXISTS `ims_ewei_shop_member_printer`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_printer` (
  ...
  KEY `idx_uniacid` (`uniacid`) USING BTREE,
  KEY `idx_createtime` (`createtime`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_printer_template`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_printer_template` (
  ...
  KEY `idx_uniacid` (`uniacid`) USING BTREE,
  KEY `idx_createtime` (`createtime`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_member_rank`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_member_rank` (
  ...
  `num` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_account`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_account` (
  ...
  KEY `idx_merchid` (`merchid`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=95 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_adv` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=26 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_banner`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_banner` (
  ...
  KEY `idx_displayorder` (`displayorder`),
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_bill`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_bill` (
  ...
  KEY `idx_merchid` (`merchid`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=26 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_billo`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_billo` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=54 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_category_swipe`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_category_swipe` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_clearing`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_clearing` (
  ...
  KEY `endtime` (`endtime`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_group`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_nav`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_nav` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_notice`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_notice` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_perm_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_perm_log` (
  ...
  KEY `idx_merchid` (`merchid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=489 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_perm_role`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_perm_role` (
  ...
  KEY `idx_deleted` (`deleted`),
  KEY `merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_reg`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_reg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=112 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_saler`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_saler` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=23 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_store`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_merch_store` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=39 ;DROP TABLE IF EXISTS `ims_ewei_shop_merch_user`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=97 ;DROP TABLE IF EXISTS `ims_ewei_shop_multi_shop`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_multi_shop` (
  ...
  `refusecontent` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_nav`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_nav` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14 ;DROP TABLE IF EXISTS `ims_ewei_shop_newstore_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_newstore_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `uniacid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_notice`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_notice` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_order`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order` (
  ...
  KEY `idx_merchid` (`merchid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=157 ;DROP TABLE IF EXISTS `ims_ewei_shop_order_comment`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_order_goods`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=162 ;DROP TABLE IF EXISTS `ims_ewei_shop_order_peerpay`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order_peerpay` (
  ...
  KEY `uniacid` (`uniacid`) USING BTREE,
  KEY `orderid` (`orderid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_order_peerpay_payinfo`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order_peerpay_payinfo` (
  ...
  `openid` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_order_print`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order_print` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_order_refund`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order_refund` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8 ;DROP TABLE IF EXISTS `ims_ewei_shop_package`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_package` (
  ...
  `displayorder` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_package_goods`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_package_goods` (
  ...
  `commission3` decimal(10,2) DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_package_goods_option`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_package_goods_option` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_payment`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_pc_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_pc_adv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8 ;DROP TABLE IF EXISTS `ims_ewei_shop_pc_link`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_pc_link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_pc_menu`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_pc_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12 ;DROP TABLE IF EXISTS `ims_ewei_shop_pc_slide`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_pc_slide` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12 ;DROP TABLE IF EXISTS `ims_ewei_shop_perm_log`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6725 ;DROP TABLE IF EXISTS `ims_ewei_shop_perm_plugin`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_perm_role`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_perm_role` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;DROP TABLE IF EXISTS `ims_ewei_shop_perm_user`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_perm_user` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_plugin`;
...
(44, 47, 'invitation', '邀请卡', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/invitation.png', '', 0, 0, 1);
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_poster`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_poster` (
  ...
  KEY `idx_isdefault` (`isdefault`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_postera`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_postera` (
  ...
  KEY `idx_isdefault` (`isdefault`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_postera_log`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_postera_qr`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_poster_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_poster_log` (
  ...
  KEY `idx_posterid` (`posterid`),
  KEY `idx_from_openid` (`from_openid`) USING BTREE
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_poster_qr`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=18 ;DROP TABLE IF EXISTS `ims_ewei_shop_poster_scan`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_poster_scan` (
  ...
  KEY `idx_openid` (`openid`) USING BTREE
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=31 ;DROP TABLE IF EXISTS `ims_ewei_shop_print`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_print` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_qa_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_qa_adv` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_qa_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_qa_category` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;DROP TABLE IF EXISTS `ims_ewei_shop_qa_question`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_qa_question` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;DROP TABLE IF EXISTS `ims_ewei_shop_qa_set`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_quick`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_quick` (
  ...
  `merchid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_quick_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_quick_adv` (
  ...
  KEY `idx_enabled` (`enabled`) USING BTREE,
  KEY `idx_displayorder` (`displayorder`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_quick_cart`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_quick_cart` (
  ...
  KEY `idx_deleted` (`deleted`) USING BTREE,
  KEY `idx_merchid` (`merchid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_refund_address`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_refund_address` (
  ...
  KEY `idx_isdefault` (`isdefault`),
  KEY `idx_deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9 ;DROP TABLE IF EXISTS `ims_ewei_shop_saler`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_saler` (
  ...
  KEY `idx_storeid` (`storeid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;DROP TABLE IF EXISTS `ims_ewei_shop_sale_coupon`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sale_coupon` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sale_coupon_data`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sale_coupon_data` (
  ...
  KEY `idx_orderid` (`orderid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_seckill_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_seckill_adv` (
  ...
  KEY `idx_enabled` (`enabled`) USING BTREE,
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_seckill_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_seckill_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_seckill_task`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_seckill_task_goods`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_seckill_task_room`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_seckill_task_room` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_taskid` (`taskid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_seckill_task_time`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_seckill_task_time` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sendticket`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sendticket` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sendticket_draw`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sendticket_draw` (
  ...
  `createtime` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sendticket_share`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sendticket_share` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sign_records`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sign_records` (
  ...
  KEY `idx_time` (`time`),
  KEY `idx_type` (`type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=602 ;DROP TABLE IF EXISTS `ims_ewei_shop_sign_set`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sign_set` (
  ...
  `share` tinyint(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;DROP TABLE IF EXISTS `ims_ewei_shop_sign_user`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sign_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=146 ;DROP TABLE IF EXISTS `ims_ewei_shop_sms`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sms` (
  ...
  `status` tinyint(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;DROP TABLE IF EXISTS `ims_ewei_shop_sms_set`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sms_set` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_adv` (
  ...
  KEY `idx_enabled` (`enabled`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_board`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_board` (
  ...
  KEY `idx_displayorder` (`displayorder`),
  KEY `idx_cid` (`cid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_board_follow`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_board_follow` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_bid` (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_category` (
  ...
  KEY `idx_isrecommand` (`isrecommand`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_complain`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_complain` (
  ...
  `deleted` tinyint(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_complaincate`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_complaincate` (
  ...
  `displayorder` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_level`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_enabled` (`enabled`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_like`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_like` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_pid` (`pid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_manage`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_manage` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_bid` (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_member`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;DROP TABLE IF EXISTS `ims_ewei_shop_sns_post`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sns_post` (
  ...
  KEY `idx_checked` (`checked`),
  KEY `idx_rpid` (`rpid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_store`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_store` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;DROP TABLE IF EXISTS `ims_ewei_shop_sysset`;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_adv` (
  ...
  `status` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_article`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_article` (
  ...
  `status` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_banner`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_banner` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_case`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_case` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_casecategory`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_casecategory` (
  ...
  `status` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_category` (
  ...
  `status` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_company_article`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_company_article` (
  ...
  `status` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_company_category`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_company_category` (
  ...
  `status` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_copyright`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_copyright` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_copyright_notice`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_copyright_notice` (
  ...
  `status` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_guestbook`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_guestbook` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_link`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_plugingrant_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_plugingrant_adv` (
  ...
  KEY `idx_enabled` (`enabled`) USING BTREE,
  KEY `idx_displayorder` (`displayorder`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_plugingrant_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_plugingrant_log` (
  ...
  `createtime` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_plugingrant_order`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_plugingrant_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_plugingrant_package`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_plugingrant_package` (
  ...
  `displayorder` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_plugingrant_plugin`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_plugingrant_plugin` (
  ...
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_plugingrant_setting`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_plugingrant_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_setting`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_setting` (
  ...
  `contact` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_system_site`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_system_site` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(32) NOT NULL DEFAULT '',
  `content` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_task`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task` (
  ...
  `logo` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_adv`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_adv` (
  ...
  `enabled` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_default`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_default` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_extension`;
...
(11, '完善信息', 'member_info', 1, 'boole', 'boole', '填写手机号', '');DROP TABLE IF EXISTS `ims_ewei_shop_task_extension_join`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_extension_join` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_join`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_join` (
  ...
  `addtime` int(11) DEFAULT '0',
  PRIMARY KEY (`join_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_joiner`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_log` (
  ...
  `createtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_poster`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_poster` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_task_poster_qr`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_poster_qr` (
  ...
  `endtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_verifygoods`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_verifygoods_log`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_verifygoods_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1 ;DROP TABLE IF EXISTS `ims_ewei_shop_version`;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_virtual_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;DROP TABLE IF EXISTS `ims_ewei_shop_virtual_data`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_virtual_data` (
  ...
  KEY `idx_orderid` (`orderid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1001 ;DROP TABLE IF EXISTS `ims_ewei_shop_virtual_type`;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_virtual_type` (
  ...
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_cate` (`cate`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;DROP TABLE IF EXISTS `ims_ewei_shop_wxcard`;
