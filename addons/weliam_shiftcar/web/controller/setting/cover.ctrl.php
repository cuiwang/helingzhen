...
$allcovers = array(
    'index' => array(
        'url' => app_url('home/index'),
        'name' => '首页'
    ),
    'record' => array(
        'url' => app_url('member/record'),
        'name' => '挪车记录'
    ),
    'member' => array(
        'url' => app_url('user/user'),
        'name' => '用户中心'
    ),
    'movecar' => array(
        'url' => app_url('home/plate_movecar'),
        'name' => '车牌挪车'
    ),
    'code_movecar' => array(
        'url' => app_url('home/code_movecar'),
        'name' => '挪车码挪车'
    ),
    'queue' => array(
        'url' => app_url('app/queue'),
        'name' => '计划任务'
    ),
    'hide' => array(
        'url' => app_url('member/hide'),
        'name' => '躲罚单'
    )
);
