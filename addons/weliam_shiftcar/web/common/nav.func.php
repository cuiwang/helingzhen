...
function getsettingFrames()
{
    ...
    $frames['cover']['items']['index']['url']     = web_url('setting/cover', array(
        'ado' => 'index'
    ));
    ...
    $frames['cover']['items']['hide']['url']     = web_url('setting/cover', array(
        'ado' => 'hide'
    ));
    $frames['cover']['items']['hide']['title']   = '躲罚单入口';
    $frames['cover']['items']['hide']['actions'] = array(
        'ado',
        'hide'
    );
    $frames['cover']['items']['hide']['active']  = '';
    
    $frames['cover']['items']['record']['url']     = web_url('setting/cover', array(
        'ado' => 'record'
    ));
    $frames['cover']['items']['record']['title']   = '挪车记录入口';
    $frames['cover']['items']['record']['actions'] = array(
        'ado',
        'record'
    );
    $frames['cover']['items']['record']['active']  = '';
    
    $frames['cover']['items']['member']['url']     = web_url('setting/cover', array(
        'ado' => 'member'
    ));
    $frames['cover']['items']['member']['title']   = '用户中心入口';
    $frames['cover']['items']['member']['actions'] = array(
        'ado',
        'member'
    );
    $frames['cover']['items']['member']['active']  = '';
    
    $frames['cover']['items']['movecar']['url']     = web_url('setting/cover', array(
        'ado' => 'movecar'
    ));
    $frames['cover']['items']['movecar']['title']   = '车牌挪车入口';
    $frames['cover']['items']['movecar']['actions'] = array(
        'ado',
        'movecar'
    );
    $frames['cover']['items']['movecar']['active']  = '';
    
    $frames['cover']['items']['code_movecar']['url']     = web_url('setting/cover', array(
        'ado' => 'code_movecar'
    ));
    $frames['cover']['items']['code_movecar']['title']   = '用户码挪车入口';
    $frames['cover']['items']['code_movecar']['actions'] = array(
        'ado',
        'code_movecar'
    );
    $frames['cover']['items']['code_movecar']['active']  = '';
    
    $frames['cover']['items']['queue']['url']     = web_url('setting/cover', array(
        'ado' => 'queue'
    ));
    $frames['cover']['items']['queue']['title']   = '计划任务入口';
    $frames['cover']['items']['queue']['actions'] = array(
        'ado',
        'queue'
    );
...
function getsystemFrames()
{
    ...
    $frames['database']['items']['addcarinfo']['title']   = '添加车辆信息';
...
function get_top_menus()
{
	...
	$frames['system']['url'] = web_url('system/account/display');
