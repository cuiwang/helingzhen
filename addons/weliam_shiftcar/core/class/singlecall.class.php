...
class Weliam_Singlecall
{
    ...
    {
        self::checkNotNull($this->calledNum, "calledNum");
        self::checkNotNull($this->calledShowNum, "calledShowNum");
        self::checkNotNull($this->ttsCode, "ttsCode");
    }
