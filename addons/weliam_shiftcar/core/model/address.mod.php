...
{
    $provinces    = pdo_fetch_many('weliam_shiftcar_address', array(
        'visible' => 2,
        'level' => 1
    ), array(), 'id');
    $cities       = pdo_fetch_many('weliam_shiftcar_address', array(
        'visible' => 2,
        'level' => 2
    ), array(), 'id');
    $districts    = pdo_fetch_many('weliam_shiftcar_address', array(
        'visible' => 2,
        'level' => 3
    ), array(), 'id');
    $address_tree = array();
