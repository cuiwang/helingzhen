...
jQuery.extend($.fn,{
    mask: function(msg,maskDivClass,maskcolor){
        ...
        if(msg){
        	var msgDiv=$('<div class="YYUCMASKMSG" style="border:#6593cf 1px solid; padding:2px;background:#fff;width:200px;position: absolute;"><div style="line-height:24px;border:#a3bad9 1px solid;background:white;padding:2px 10px 2px 10px;text-align:center;" id="maskmsgdiv">'+msg+'</div></div>');
