gameurl = 'http://timelineapp.didaren.com/coreball/';
imgUrl = "http://timelineapp.didaren.com/coreball/image/icon.png";
...
"undefined" == typeof window.define && (window.define = function() {}, window.define.amd = 1),
    ...
    $AJB.general.Game = function() {
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            B = "sinaweibo://share?content=Core Ball，我已玩到第#{level}关了，你也来试试吧！ http://timelineapp.didaren.com/coreball/",
            C = m(s),
            D = +o.getValue(z) || 1,
            E = !1,
            F = 0,
...
ajax.post('http://timelineapp.didaren.com/ci/authorize/get_jssdk_info', {
