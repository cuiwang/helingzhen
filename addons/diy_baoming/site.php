...
define('STYLE_PATH', '../addons/diy_baoming/template/style');
define('MB_ROOT', IA_ROOT . '/addons/diy_baoming');
require MB_ROOT . '/inc/util.php';
require MB_ROOT . '/inc/common.php';
//作者海纳百川qq:1120924338
class diy_baomingModuleSite extends WeModuleSite {
	...
	public function forward($id, $from_user,$activity=array()) {
		...
		if (empty ($user)) {
		  ...
		  if (empty($user['is_pay']) && ($activity['activity_type'])==2){
