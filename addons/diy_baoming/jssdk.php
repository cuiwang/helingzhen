<?php
    ...
    function getSignPackage($weid,$appIfo) {
     ...
     function getJsApiTicket($weid,$appIfo) {
        ...
        $data = cache_load("diy_baoming.jsapi_ticket.json::".$appIfo['appid'], true);
        ...
        if (empty($data['expire_time']) || $data['expire_time'] < time()) {
            ...
            if ($ticket) {
                ...
                cache_write("diy_baoming.jsapi_ticket.json::".$appIfo['appid'], iserializer($data));
     ...
     function getAccessToken($weid,$appIfo) {
        ...
        $data = cache_load("diy_baoming.access_token.json::".$appIfo['appid'], true);
        ...
        if (empty($data['expire_time']) || $data['expire_time'] < time()) {
            ...
            if ($access_token) {
                ...
                cache_write("diy_baoming.access_token.json::".$appIfo['appid'], iserializer($data));
            } else {
