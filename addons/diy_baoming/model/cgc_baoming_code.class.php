...
class cgc_baoming_code
{
    public function __construct()
    {
        $this->table_name = 'cgc_baoming_code';
        $this->columns = '*';
       $this->activity_table_name = 'cgc_baoming_activity';
   ...
   public function get_activity($con) {
        global $_W;
        $sql = "SELECT * FROM " . tablename($this->activity_table_name) . " WHERE {$con}";   
