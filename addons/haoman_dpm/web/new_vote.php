...
foreach ($rowlist as $k => $v) {
    $rowlist[$k]['awardstotal'] = pdo_fetchcolumn('select count(*) from ' . tablename('haoman_dpm_newvote') . 'where uniacid = :uniacid and rid=:rid', array(':uniacid' => $_W['uniacid'],':rid' => $v['id']));
