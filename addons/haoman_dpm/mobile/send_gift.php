...
//
//
$bbgift = pdo_fetchall( " SELECT * FROM ".tablename('haoman_dpm_bbgift')." WHERE rid=:rid and type=:type order by sort desc,bb_price asc",array(':rid'=>$rid,':type'=>1) );
//
$price= $bbgift[0]['bb_price'];
...
//}else{
    include $this->template('mob_send_gift');
//}