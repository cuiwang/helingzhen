...
CREATE TABLE IF NOT EXISTS `ims_mon_jgg_sn` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `jid` int(10) NOT NULL,
  `uid` int(10) NOT NULL,
...
if(!pdo_fieldexists('mon_jgg',  'award_count')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg')." ADD `award_count` int(10) DEFAULT '0';");
}
...
if(!pdo_fieldexists('mon_jgg_sn',  'id')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_sn')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('mon_jgg_sn',  'jid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_sn')." ADD `jid` int(10) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_sn',  'uid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_sn')." ADD `uid` int(10) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_sn',  'sn')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_sn')." ADD `sn` varchar(500) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_sn',  'createtime')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_sn')." ADD `createtime` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists('mon_jgg_user',  'id')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('mon_jgg_user',  'jid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `jid` int(10) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'openid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `openid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'nickname')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `nickname` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'headimgurl')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `headimgurl` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'address')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `address` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'tel')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `tel` varchar(20) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'uname')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `uname` varchar(20) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user',  'createtime')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user')." ADD `createtime` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'id')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'jid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `jid` int(10) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'uid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `uid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'openid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `openid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'award_name')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `award_name` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'award_level')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `award_level` varchar(200) NOT NULL;");
}
...
if(!pdo_fieldexists('mon_jgg_user_award',  'status')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `status` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'remark')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `remark` varchar(200) DEFAULT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_award',  'createtime')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_award')." ADD `createtime` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists('mon_jgg_user_record',  'id')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('mon_jgg_user_record',  'jid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `jid` int(10) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_record',  'uid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `uid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_record',  'openid')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `openid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_record',  'award_name')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `award_name` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists('mon_jgg_user_record',  'award_level')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `award_level` varchar(200) NOT NULL;");
}
...
if(!pdo_fieldexists('mon_jgg_user_record',  'createtime')) {
	pdo_query("ALTER TABLE ".tablename('mon_jgg_user_record')." ADD `createtime` int(10) DEFAULT '0';");
}
