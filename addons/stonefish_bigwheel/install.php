<?php
pdo_query("CREATE TABLE IF NOT EXISTS `ims_stonefish_bigwheel_exchange` (
...
`othermodule` varchar(50),
`credit_type` varchar(20),
`credit_value` int(11),
`turntable` tinyint(1),
`turntablenum` tinyint(1),
`bigwheelpic` varchar(225) NOT NULL,
`bigwheelimg` varchar(225) NOT NULL,
`bigwheelimgan` varchar(225) NOT NULL,
`bigwheelimgbg` varchar(225) NOT NULL,
`prizeDeg` varchar(225) NOT NULL,
`lostDeg` varchar(225) NOT NULL,
`againDeg` varchar(225) NOT NULL,
`createtime` int(10),
`sys_users` varchar(500),
