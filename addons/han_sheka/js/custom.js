...
jQuery(document).ready(function($){
	...
	function adaptPortfolio(){
		...
		var recentProjectItemWidth = ($('.recentProjectsOuterWrapper').width() - 26)/2;
	...
	$('.accordionButton').click(function(e){
		...
		if($(this).hasClass('currentAccordion')){
			 ...
			 $(this).parent().find('.accordionContentWrapper').stop(true, true).animate({height:'hide'}, 30, 'easeOutCubic', function(){$(this).parent().find('.accordionButton').removeClass('currentAccordion');});
			 
		}else{
			 
			$(this).parent().find('.accordionContentWrapper').stop(true, true).animate({height:'show'}, 30, 'easeOutCubic', function(){$(this).parent().find('.accordionButton').addClass('currentAccordion');});
