...
function PromptBox(){
	...
	this.showShade = function(){
		...
		if(PromptBoxShade){
			...
			PromptBoxShade.style.cssText = 'background-color:gray;left:0;opacity:0.5;position:absolute;top:0;z-index:9999999;filter:alpha(opacity=50);-moz-opacity:0.5;-khtml-opacity:0.5;';
	...
	this.showMsg = function(){
		...
		if(doc.clientWidth === PBObj.offsetWidth){
			PBX = "30";
		}
		PBObj.style.left = PBX+'px';
		PBObj.style.right = PBX+'px';
