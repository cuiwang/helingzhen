...
class WxPayDataBase
{
	...
	* @param string $value 
	**/
	public function SetSign($key = null)
	{
	...
	**/
	 ...
	 */
	public function MakeSign($key = WxPayConfig::KEY)
	{
		//签名步骤一：按字典序排序参数
		ksort($this->values);
 ...
 *
 */
class WxPayEnterprisePay extends WxPayDataBase {
	/* 设置微信分配的公众账号ID
	* @param string $value 
	**/
...
class WxPayRedPacketPay extends WxPayDataBase {
	public function SetNonce_str($value) {
		$this->values['nonce_str'] = $value;
	}
	public function GetNonce_str() {
