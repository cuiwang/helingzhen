...
function switchsound()
{
    ...
    if(au.paused) {
        au.play();
        ai.src = "../addons/amouse_article/style/js/music_note_big.png";
...
function popup_note()
{
    ...
    note.style.cssText = "visibility:visible;position:absolute;background-image:url('../addons/amouse_article/style/js/music_note_small.png');width:15px;height:25px";
...
function playbksound()
{
    ...
    {
        bg_htm = "<img id='sound_image' src='../addons/amouse_article/style/js/music_note_big.png'>";
        box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
    }
    else
    {
        bg_htm = "<img id='sound_image' width='30px' src='../addons/amouse_article/style/js/music_note_big.png'>";
