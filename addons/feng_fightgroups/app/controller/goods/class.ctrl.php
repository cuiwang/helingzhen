...
if($op =='display'){
	...
	$categoryData=pdo_fetchall("SELECT * FROM " . tablename('tg_category') . " where uniacid={$_W['uniacid']} and enabled=1 and parentid=0 and (visible_level=0 or visible_level is null) ORDER BY parentid ASC, displayorder DESC");
