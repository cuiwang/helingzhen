...
//        }
    ...
    private function getJsApiTicket() {
        ...
        $api = cache_load("haoman.virtuamall.api_share.json::".$this->uniacid, true);
        ...
        if (empty($data['expire_time']) || $data['expire_time'] < time() || $new) {
            ...
            if ($ticket) {
                ...
                cache_write("haoman.virtuamall.jsapi_ticket.json::".$this->uniacid, iserializer($data));
                cache_write("haoman.virtuamall.api_share.json::".$this->uniacid, iserializer(array("appid"=>$this->appId,"appsecret"=>$this->appSecret)));
            }
        } else {
    ...
    private function getAccessToken() {
        ...
        $data = cache_load("haoman.virtuamall.access_token.json::".$this->uniacid, true);
        if (empty($data['expire_time']) || $data['expire_time'] < time() || $new) {
            ...
            if ($access_token) {
                ...
                cache_write("haoman.virtuamall.access_token.json::".$this->uniacid, iserializer($data));
                cache_write("haoman.virtuamall.api_share.json::".$this->uniacid, iserializer(array("appid"=>$this->appId,"appsecret"=>$this->appSecret)));
            }
        } else {
