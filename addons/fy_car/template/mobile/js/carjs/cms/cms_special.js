        ...
        dataType: 'json',
            ...
            add: function(e,data) {
                ...
                if(result.status == "success") {
                    ...
                    image_content += '<div class="size-64x64"><span class="thumb size-64x64"><i></i><img src="'+result.file_url+'" alt="" /></span></div>';
                    image_content += '<p class="handle">';
                    image_content += '<a nctype="btn_show_image_insert_link" image_url="'+result.file_url+'" class="insert-link tooltip" title="以图片链接模式插入专题页">&nbsp;</a>';
                    image_content += '<a nctype="btn_show_image_insert_hot_point" image_name="'+result.file_name+'" image_url="'+result.file_url+'" class="insert-hotpoint tooltip " title="以热点链接模式插入专题页">&nbsp;</a>';
                    image_content += '<a nctype="btn_drop_special_image" image_name="'+result.file_name+'" class="delete tooltip " title="删除该图片">&nbsp;</a>';
					image_content += '</p>';
                    image_content += '<input name="special_image_all[]" type="hidden" value="'+result.file_name+'" />';
                    image_content += '</li>';
