<?php
$sql="CREATE TABLE IF NOT EXISTS `ims_weisrc_businesscenter_area` (
...
CREATE TABLE IF NOT EXISTS `ims_weisrc_businesscenter_stores` (
  ...
  `discount_url` varchar(500) NOT NULL DEFAULT '' COMMENT '折扣链接',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_weisrc_dish_businesslog` (
  ...
  `price` varchar(20) DEFAULT '' COMMENT '申请金额',
  `haveprice` varchar(20) DEFAULT '' COMMENT '已申请总金额',
  `totalprice` varchar(20) DEFAULT '' COMMENT '当时可总金额',
  ...
  `charges` varchar(20) DEFAULT '' COMMENT '手续费',
  `successprice` varchar(20) DEFAULT '' COMMENT '到帐金额',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
";
pdo_run($sql);
if(!pdo_fieldexists('weisrc_businesscenter_area',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_area')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_category',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_category')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_category',  'logo')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_category')." ADD `logo` varchar(500) DEFAULT '' COMMENT '商家logo';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_category',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_category')." ADD `url` varchar(500) DEFAULT '' COMMENT '网址';");
}
if(!pdo_fieldexists('weisrc_businesscenter_city',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_city')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_feedback',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_feedback')." ADD `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_feedback',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_feedback')." ADD `from_user` varchar(100) DEFAULT NULL;");
}
if(!pdo_fieldexists('weisrc_businesscenter_feedback',  'nickname')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_feedback')." ADD `nickname` varchar(30) DEFAULT NULL;");
}
if(!pdo_fieldexists('weisrc_businesscenter_feedback',  'content')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_feedback')." ADD `content` varchar(600) DEFAULT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_feedback',  'status')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_feedback')." ADD `status` tinyint(1) DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_feedback',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_feedback')." ADD `dateline` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_news',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('weisrc_businesscenter_news',  'weid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `weid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_news',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `title` varchar(200) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_news',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `thumb` varchar(500) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_news',  'summary')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `summary` varchar(1000) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_news',  'description')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `description` text NOT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_news',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `url` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_news',  'displayorder')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_news',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_news')." ADD `dateline` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'weid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `weid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_product',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `title` varchar(200) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'price')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `price` varchar(50) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `thumb` varchar(500) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'thumbs')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `thumbs` text;");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'description')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `description` text NOT NULL;");
}
if(!pdo_fieldexists('weisrc_businesscenter_product',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `url` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_product',  'displayorder')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_product',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_product')." ADD `dateline` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `title` varchar(100) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'bg')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `bg` varchar(500) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'topcolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `topcolor` varchar(20) NOT NULL DEFAULT '' COMMENT '顶部字体颜色';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'topbgcolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `topbgcolor` varchar(20) NOT NULL DEFAULT '' COMMENT '顶部字体颜色';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'announcebordercolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `announcebordercolor` varchar(20) NOT NULL DEFAULT '' COMMENT '公告边框颜色';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'announcebgcolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `announcebgcolor` varchar(20) NOT NULL DEFAULT '' COMMENT '公告背景颜色';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'announcecolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `announcecolor` varchar(20) NOT NULL DEFAULT '' COMMENT '公告字体颜色';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'storestitlecolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `storestitlecolor` varchar(20) NOT NULL DEFAULT '' COMMENT '商家名称颜色';");
}
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'storesstatuscolor')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `storesstatuscolor` varchar(20) NOT NULL DEFAULT '' COMMENT '商家状态颜色';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_setting',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_setting')." ADD `dateline` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'weid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `weid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `title` varchar(100) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `url` varchar(200) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'storeid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'description')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `description` varchar(1000) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'attachment')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `attachment` varchar(500) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'displayorder')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_slide',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_slide')." ADD `dateline` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `title` varchar(50) NOT NULL DEFAULT '' COMMENT '名称';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'description')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `description` text;");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `url` varchar(200) NOT NULL DEFAULT '' COMMENT '微站网址';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'shop_url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `shop_url` varchar(400) NOT NULL DEFAULT '' COMMENT '折扣链接';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'logo')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `logo` varchar(200) NOT NULL DEFAULT '' COMMENT '商家logo';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'qrcode')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `qrcode` varchar(200) NOT NULL DEFAULT '' COMMENT '商家logo';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'services')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `services` varchar(200) NOT NULL DEFAULT '' COMMENT '服务范围';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'tel')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `tel` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'place')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `place` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'hours')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `hours` varchar(200) NOT NULL DEFAULT '' COMMENT '营业时间';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'location_p')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `location_p` varchar(100) NOT NULL DEFAULT '' COMMENT '省';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'location_c')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `location_c` varchar(100) NOT NULL DEFAULT '' COMMENT '市';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'location_a')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `location_a` varchar(100) NOT NULL DEFAULT '' COMMENT '区';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'displayorder')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `displayorder` tinyint(3) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'updatetime')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `updatetime` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `dateline` int(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'discount')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `discount` varchar(100) NOT NULL DEFAULT '' COMMENT '会员折扣';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'aid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `aid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'content')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `content` varchar(1000) NOT NULL DEFAULT '' COMMENT '简介';");
}
if(!pdo_fieldexists('weisrc_businesscenter_stores',  'discount_url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_stores')." ADD `discount_url` varchar(500) NOT NULL DEFAULT '' COMMENT '折扣链接';");
}
if(!pdo_fieldexists('weisrc_businesscenter_template',  'id')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_template')." ADD `id` int(10) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('weisrc_businesscenter_template',  'weid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_template')." ADD `weid` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_businesscenter_template',  'template_name')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_businesscenter_template')." ADD `template_name` varchar(50) NOT NULL DEFAULT 'style1';");
}
...
if(!pdo_fieldexists('weisrc_dish_businesslog',  'weid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'storeid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_dish_businesslog',  'price')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `price` varchar(20) DEFAULT '' COMMENT '申请金额';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'haveprice')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `haveprice` varchar(20) DEFAULT '' COMMENT '已申请总金额';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'totalprice')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `totalprice` varchar(20) DEFAULT '' COMMENT '当时可总金额';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'status')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'handletime')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `handletime` int(10) DEFAULT '0' COMMENT '处理时间';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `dateline` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'dining_mode')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `dining_mode` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '类型1店内2外卖3预定4快餐';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'charges')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `charges` varchar(20) DEFAULT '' COMMENT '手续费';");
}
if(!pdo_fieldexists('weisrc_dish_businesslog',  'successprice')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `successprice` varchar(20) DEFAULT '' COMMENT '到帐金额';");
}
