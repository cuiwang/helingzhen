define("app/mLejuWxV1/kft/kft", ["gallery/zepto/1.1.3/zepto", "../module/menu", "../module/share"], function (a) {
    var b = a("gallery/zepto/1.1.3/zepto");
    b("#menu").length > 0 && a("../module/menu"), a("../module/share");
    var c = (b("#subtn").on("click", function () {
        var a = b("#name"), d = b("#mobile");
        a.val().length > 0 && d.val().length > 0 ? b.post(b("#kft_form").attr("action"), b("#kft_form").serialize(), function (e) {
            if ("succ" == e.result) {
                b("#kft_form").hide();
                var f = b("#cName"), g = b("#cPhone");
                f.length > 0 && f.text(f.text() + a.val()), g.length > 0 && g.text(g.text() + d.val()), b("#succ").show()
            } else c(e.info)
        }, "json") : c("请正确填写您的信息，便于我们及时联系到您。")
    }), function (a) {
        var c = b('<div class="cuowu">' + a + "</div>");
        b("body").append(c), window.setTimeout(function () {
            c.remove()
        }, 2e3)
    })
}), define("gallery/zepto/1.1.3/zepto", [], function () {
    var a = window.Zepto, b = window.$, c = function () {
        function a(a) {
    ...
    return window.Zepto = c, void 0 === window.$ && (window.$ = c), function (a) {
        function b(a) {
    ...
    }(c), window.Zepto = a, window.$ = b, c
}), define("app/mLejuWxV1/module/menu", ["gallery/zepto/1.1.3/zepto"], function (a) {
    var b = a("gallery/zepto/1.1.3/zepto"), c = b(".menuItem");
    b(document).ready(function () {
        var a = c.find(".yblis");
        c.each(function () {
            b(this).on("click", function () {
                var c = b(".yblis", this);
                c.hasClass("none") ? (a.addClass("none"), c.removeClass("none")) : a.addClass("none")
            })
        }), b("a", c).on("click", function () {
            location.href = this.href
        })
    })
}), define("app/mLejuWxV1/module/share", ["gallery/zepto/1.1.3/zepto"], function (a) {
    var b = a("gallery/zepto/1.1.3/zepto"), c = b(".maskshare"), d = b("img", c), e = b("#shareBtn");
    b(document).ready(function () {
        function a() {
            var a = b(window).scrollTop();
            return c.height(b(window).height() + a), c.removeClass("none"), d.css("margin-top", a), b(document).on("click", f), b(window).on("scroll", g), !1
        }

        function f() {
            return c.addClass("none"), b(document).off("click", f), b(window).off("scroll", g), !1
        }

        function g() {
            d.css("margin-top", b(window).scrollTop())
        }

        c.length && e.length && b("#shareBtn").on("click", a)
    })
});