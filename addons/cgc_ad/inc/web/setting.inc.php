<?php
        ...
        if(checksubmit()) {
            ...
            $input = array_elements(array('task_template_id','secret','appid',  'mchid', 'password','qq','kf_openid','tuisong','is_type','template_id','ip', 'bd_ak', 'qn_ak', 'qn_sk', 'pay_type','yunpay_no','yunpay_pid','yunpay_key','qn_bucket', 'qn_api','is_qniu','rush_text','unit_text','recruit_template_id','percentage_template_id'), $_GPC);
		    ...
		    $input['recruit_template_id'] = trim($input['recruit_template_id']);
		    $input['percentage_template_id'] = trim($input['percentage_template_id']);
