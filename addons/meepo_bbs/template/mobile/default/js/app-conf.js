...
var STATIC = {
	AVATAR: '../addons/meepo_bbs/template/mobile/img/avatar.png',
	HOLDER: '../addons/meepo_bbs/template/mobile/img/holder.png',
	QINIU_API: '?imageView2/0/w/128/h/128'
};

var ERROR = {
	WRONG_ACCESSTOKEN: '请在微信浏览器打开',
	HEHE_YOU_CANNOT: '呵呵，不能帮自己点赞。',
	IS_NOT_EXISTS: '主题不存在或已删除',
	TIME_OUT: 5000
};
