...
function(a) {
    ...
    a.ajax = function(b) {
        ...
        var n = e.dataType,
        o = /\?.+=\?/.test(e.url);
        if ("jsonp" == n || o) return o || (e.url = l(e.url, e.jsonp ? e.jsonp + "=?": e.jsonp === !1 ? "": "callback=?")),
        a.ajaxJSONP(e, i);
        var r, s = e.accepts[n],
        t = {},
        u = function(a, b) {
        ...
        if (i && i.promise(w), e.crossDomain || u("X-Requested-With", "XMLHttpRequest"), u("Accept", s || "*/*"), (s = e.mimeType || s) && (s.indexOf(",") > -1 && (s = s.split(",", 2)[0]), w.overrideMimeType && w.overrideMimeType(s)), (e.contentType || e.contentType !== !1 && e.data && "GET" != e.type.toUpperCase()) && u("Content-Type", e.contentType || "application/x-www-form-urlencoded"), e.headers) for (q in e.headers) u(q, e.headers[q]);
        if (w.setRequestHeader = u, w.onreadystatechange = function() {
            if (4 == w.readyState) {
                ...
                if (w.status >= 200 && w.status < 300 || 304 == w.status || 0 == w.status && "file:" == v) {
                    ...
                    b = w.responseText;
                    try {
                        "script" == n ? (1, eval)(b) : "xml" == n ? b = w.responseXML: "json" == n && (b = y.test(b) ? null: a.parseJSON(b))
                    } catch(d) {
                        c = d
                    }
                    c ? h(c, "parsererror", w, e, i) : g(b, w, e, i)
                } else h(w.statusText || null, w.status ? "error": "abort", w, e, i)
            }
        },
        f(w, e) === !1) return w.abort(),
        h(null, "abort", w, e, i),
        w;
        if (e.xhrFields) for (q in e.xhrFields)"withCredentials" !== q && (w[q] = e.xhrFields[q]);
        var z = "async" in e ? e.async: !0;
        w.open(e.type, e.url, z, e.username, e.password),
        e.xhrFields && e.xhrFields.withCredentials && (w.withCredentials = !0);
        for (q in t) x.apply(w, t[q]);
...
function(a) {
    function b(a) {
        ...
        v = u || a.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/); (c.webkit = !!d) && (c.version = d[1]),
        ...
        k && (b.touchpad = !0),
        n && (b.blackberry = !0, b.version = n[2]),
        o && (b.bb10 = !0, b.version = o[2]),
        p && (b.rimtabletos = !0, b.version = p[2]),
        q && (c.playbook = !0),
        l && (b.kindle = !0, b.version = l[1]),
        m && (c.silk = !0, c.version = m[1]),
        !m && b.android && a.match(/Kindle Fire/) && (c.silk = !0),
        r && (c.chrome = !0, c.version = r[1]),
        s && (c.firefox = !0, c.version = s[1]),
        t && (c.ie = !0, c.version = t[1]),
        v && (f || b.ios) && (c.safari = !0, f && (c.version = v[1])),
        u && (c.webview = !0),
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        function(a) {
            ...
            b && (n.el.trigger("swipe"), n.el.trigger("swipe" + b))
        ...
        function(b) {
            if (a.os.ios) {
                ...
                var d = b.target,
                e = d;
                for (y = {}; e;) e.id || (e.id = "d_" + +new Date),
                y[e.id] = a(e).scrollTop(),
                e = e.parentNode
            } (!(C = g(b, "down")) || f(b)) && (B = C ? b: b.touches[0], b.touches && 1 === b.touches.length && n.x2 && (n.x2 = void 0, n.y2 = void 0), z = Date.now(), A = z - (n.last || z), n.el = a("tagName" in B.target ? B.target: B.target.parentNode), h && clearTimeout(h), n.x1 = B.pageX, n.y1 = B.pageY, A > 0 && 500 >= A && (n.isDoubleTap = !0), n.last = z, k = setTimeout(c, o), l && C && l.addPointer(b.pointerId))
        }).on("touchmove MSPointerMove pointermove",
        function(b) {
            if ((! (C = g(b, "move")) || f(b)) && (B = C ? b: b.touches[0], d(), n.x2 = B.pageX, n.y2 = B.pageY, D += Math.abs(n.x1 - n.x2), E += Math.abs(n.y1 - n.y2), a.os.ios)) {
                if (x[v]);
                else for (var c = b.target,
                e = c; e;) {
        ...
        function(c) {
            if (! (C = g(c, "up")) || f(c)) {
                if (d(), n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30) {
                    ...
                    0), a.os.ios && x[v]) {
                        ...
                        Math.abs(s) > .5 ? m = setInterval(function() {
                            var b = a(k).scrollTop();
                            q == b ? p = 1 : (p = 0, clearInterval(m))
                        },
                        20) : p = 0
                    }
                } else if ("last" in n) var w = +new Date - n.last;
                if (30 > D && 30 > E) if (o >= w) i = setTimeout(function() {
                    if (a.os.ios && p) return void(p = 0);
                    var b = a.Event("tap");
                    b.cancelTouch = e,
                    n.el && n.el.trigger(b),
                    n.isDoubleTap ? (n.el && n.el.trigger("doubleTap", [c]), n = {}) : h = setTimeout(function() {
                        h = null,
...
function(a) {
    ...
    var g, h = /\+/g,
    i = a.cookie = function(e, h, j) {
        if (void 0 !== h && !a.isFunction(h)) {
            if (j = a.extend({},
            i.defaults, j), "number" == typeof j.expires) {
                var k = j.expires,
