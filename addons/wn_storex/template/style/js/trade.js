			...
			var consume = {
				...
				'getuser': function(){
					...
					$('#username').blur(function(){
						...
						var type = $('#type').val();
						if(username) {
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=user&m=wn_storex&', {'type':type, 'username':username}, function(data){
				...
				'submit': function() {
					...
					$('#form-consume #submit-form').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=consume&m=wn_storex&', param, function(data){
								if(data != 'success') {
				...
				'submit': function() {
					...
					$('#form-credit .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=credit&m=wn_storex', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
				...
				'submit': function() {
					...
					$('#form-card .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=card&m=wn_storex&', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
				...
				'submit': function() {
					...
					$('#form-card .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=cardconsume&m=wn_storex&', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
				...
				fields: {
					...
					cardsn: {
						validators: {
							...
							remote: {
								url: "./index.php?c=site&a=entry&do=cardmanage&op=cardsn&type=check&m=wn_storex",
				...
				'submit': function() {
					...
					$('#form-card .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=cardsn&m=wn_storex&', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
