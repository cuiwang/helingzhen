...
var mui = function(a, b) {
    ...
    i.map = function(a, b) {
        var c, d, e, f = [];
        if ("number" == typeof a.length) for (d = 0, len = a.length; len > d; d++) c = b(a[d], d),
        null != c && f.push(c);
    ...
    i.each = function(a, b) {
        ...
        else for (key in a) if (b.call(a[key], key, a[key]) === !1) return a;
        return this
    },
...
function(a) {
    var b = 0;
    a.requestAnimationFrame || (a.requestAnimationFrame = a.webkitRequestAnimationFrame, a.cancelAnimationFrame = a.webkitCancelAnimationFrame || a.webkitCancelRequestAnimationFrame),
...
function(a, b) {
    ...
    j = function(b) {
        if (!a.gestures.stoped) {
            var c = Date.now();
            g.touchTime = c - g.startTime,
            g.flickTime = c - g.flickStartTime,
            g.flickDistanceX = g.move.x - g.flickStart.x,
            g.flickDistanceY = g.move.y - g.flickStart.y,
            g.gesture = b,
            f(b, g)
        }
    };
    b.addEventListener(a.EVENT_START, h),
    b.addEventListener(a.EVENT_MOVE, i),
    b.addEventListener(a.EVENT_END, j),
    b.addEventListener(a.EVENT_CANCEL, j),
    b.addEventListener(a.EVENT_CLICK,
    function(b) { (a.targets.popover || a.targets.tab || a.targets.offcanvas || a.targets.modal) && b.preventDefault()
    }),
    a.fn.on = function(b, c, d) {
        this.each(function() {
            ...
            e.removeEventListener(a.EVENT_CLICK, k),
            e.addEventListener(a.EVENT_CLICK, k)
        })
    };
    var k = function(a) {
...
function(a) {
    ...
    a.initGlobal = function(b) {
        return a.options = a.extend(a.global, b, !0),
        this
    };
    var b = {};
    a.init = function(c) {
        return a.options = a.extend(a.global, c || {},
        !0),
        a.ready(function() {
            a.each(a.inits,
            function(c, d) {
...
function(a) {
    ...
    a.options.show && (c = a.extend(c, a.options.show, !0)),
    a.currentWebview = null,
    a.isHomePage = !1,
    a.extend(a.global, b),
    a.extend(a.options, b),
    ...
    a.registerInit({
        ...
        handle: function() {
            ...
            a.plusReady(function() {
                ...
                300)), a.os.ios) {
                    var b = a.options.statusBarBackground ? a.options.statusBarBackground: "#f7f7f7";
                    plus.navigator.setStatusBarBackground(b)
                }
            })
        }
    }),
...
function(a, b) {
    ...
    a.back = function() { ("function" != typeof a.options.back || a.options.back() !== !1) && a.each(a.backs,
        function(a, b) {
            return ! b.handle()
        })
    },
    ...
    function(b) {
        var c = b.detail;
        c.angle > -15 && c.angle < 15 && a.options.swipeBack === !0 && a.back()
    })
} (mui, window),
function(a, b) {
    a.registerBack({
...
function(a) {
    a.registerInit({
        ...
        handle: function() {
            var b = a.options,
            c = b.pullRefresh || {};
            if (c.down && c.down.hasOwnProperty("callback") || c.up && c.up.hasOwnProperty("callback")) {
                var d = c.container;
                if (d) {
                    var e = a(d);
                    1 === e.length && (a.os.plus && a.os.android ? a.plusReady(function() {
                        e.pullRefresh(c)
                    }) : e.pullRefresh(c))
                }
            }
...
function(a, b, c) {
    ...
    m = function(b, c, d, e) {
        ...
        function(c, i) {
            ...
            !e && g ? b.add(i.name, i.value) : "array" == f || !d && "object" == f ? m(b, i, d, c) : b.add(c, i)
        })
    },
    n = function(b) {
        b.processData && b.data && "string" != typeof b.data && (b.data = a.param(b.data, b.traditional)),
        !b.data || b.type && "GET" != b.type.toUpperCase() || (b.url = o(b.url, b.data), b.data = c)
    },
    o = function(a, b) {
    ...
    a.ajax = function(d, e) {
        ...
        if (s.setRequestHeader = q, s.onreadystatechange = function() {
            if (4 == s.readyState) {
                ...
                if (s.status >= 200 && s.status < 300 || 304 == s.status || 0 == s.status && "file:" == r) {
                    g = g || p(f.mimeType || s.getResponseHeader("content-type")),
                    b = s.responseText;
                    try {
        ...
        return f.timeout > 0 && (h = setTimeout(function() {
            s.onreadystatechange = a.noop,
            s.abort(),
            k(null, "timeout", s, f, deferred)
        },
        f.timeout)),
        s.send(f.data ? f.data: null),
        s
    },
...
function(a, b, c, d) {
    ...
    j = a.Class.extend({
        ...
        _initIndicators: function() {
            ...
            if (a.indicators = [], this.options.indicators) {
                ...
                this.wrapper.addEventListener("beforescrollstart",
                function() {
                    a.indicators.map(function(a) {
                        a.fade(1, !0)
                    })
        ...
        _start: function() {
            if (this.moved = this.needReset = !1, this._transitionTime(), this.isInTransition) {
                ...
                this.setTranslate(Math.round(b.x), Math.round(b.y)),
        ...
        _drag: function(b) {
            var c = b.detail;
            c.gesture && c.gesture.preventDefault();
            var d = c.deltaX - c.lastDeltaX,
            e = c.deltaY - c.lastDeltaY,
            f = Math.abs(c.deltaX),
            g = Math.abs(c.deltaY);
            f > g + this.options.directionLockThreshold ? e = 0 : g >= f + this.options.directionLockThreshold && (d = 0),
            d = this.hasHorizontalScroll ? d: 0,
            e = this.hasVerticalScroll ? e: 0;
            var h = this.x + d,
            i = this.y + e; (h > 0 || h < this.maxScrollX) && (h = this.options.bounce ? this.x + d / 3 : h > 0 ? 0 : this.maxScrollX),
            ...
            this.moved || a.trigger(this.wrapper, "scrollstart", this),
            this.moved = !0,
            this.x = h,
            this.y = i
        },
        _flick: function(b) {
            ...
            if (this._clearRequestAnimationFrame(), "dragend" !== b.type || !c.flick) {
                ...
                if (this.isInTransition = !1, !this.resetPosition(this.options.bounceTime)) {
                    ...
                    d = momentumX.destination, e = momentumY.destination, f = Math.max(momentumX.duration, momentumY.duration), this.isInTransition = !0), d != this.x || e != this.y) return (d > 0 || d < this.maxScrollX || e > 0 || e < this.maxScrollY) && (g = i.quadratic),
        ...
        _end: function() { ! this.moved && this.needReset && this.resetPosition(this.options.bounceTime)
        },
        ...
        _scrollend: function() {
            this.y <= this.maxScrollY && a.trigger(this.wrapper, "scrollbottom", this)
        },
        _resize: function() {
            var a = this;
    ...
    k.prototype = {
        ...
        updatePosition: function() {
            ...
            this.x = a,
            this.y = b,
            this.indicatorStyle.webkitTransform = "translate3d(" + a + "px," + b + "px,0px)" + this.scroller.translateZ
        },
        fade: function(a, b) {
            if (!b || this.visible) {
    ...
    a.fn.scroll = function(b) {
        this.each(function() {
            var c = this.getAttribute("data-scroll");
            c || (c = ++a.uuid, a.data[c] = new j(this, b), this.setAttribute("data-scroll", c))
        })
    }
} (mui, window, document),
function(a, b, c) {
    ...
    q = g + " " + i + " " + k,
    r = g + " " + i + " " + j + " " + l,
    s = ['<div class="' + f + '">', '<div class="' + q + '"></div>', '<div class="' + h + '">{downCaption}</div>', "</div>"].join(""),
    t = a.Scroll.extend({
        init: function(b, c) {
        ...
        _initPocket: function() {
            var a = this.options;
            a.down && a.down.hasOwnProperty("callback") && (this.topPocket = this.scroller.querySelector("." + d), this.topPocket || (this.topPocket = this._createPocket(d, a.down), this.wrapper.insertBefore(this.topPocket, this.wrapper.firstChild), this.topLoading = this.topPocket.querySelector("." + g), this.topCaption = this.topPocket.querySelector("." + h))),
            a.up && a.up.hasOwnProperty("callback") && (this.bottomPocket = this.scroller.querySelector("." + e), this.bottomPocket || (this.bottomPocket = this._createPocket(e, a.up), this.scroller.appendChild(this.bottomPocket), this.bottomLoading = this.bottomPocket.querySelector("." + g), this.bottomCaption = this.bottomPocket.querySelector("." + h)), this.wrapper.addEventListener("scrollbottom", this))
        },
        handleEvent: function(a) {
            this._super(a),
        ...
        _createPocket: function(a, b) {
            var d = c.createElement("div");
            return d.className = a,
            d.innerHTML = s.replace("{downCaption}", b.contentdown),
            d
        },
        _setCaption: function(a) {
            if (!this.loading) {
                var b = this.options,
                c = this.pullPocket;
                if (c && a !== this.lastTitle) {
                    var d = this.pullCaption,
                    e = this.pullLoading;
                    d.innerHTML = a; {
                        this.pulldown
                    }
                    this.pulldown ? a === b.down.contentrefresh ? e.className = r: a === b.down.contentover ? e.className = p: a === b.down.contentdown && (e.className = q) : e.className = a === b.up.contentrefresh ? r + " " + m: r,
                    this.lastTitle = a
                }
            }
        },
        ...
        endPulldownToRefresh: function() {
            this.topPocket && (this.scrollTo(0, 0, this.options.bounceTime, this.options.bounceEasing), this.loading = !1, this._setCaption(this.options.down.contentdown))
        },
        pullupLoading: function(a, b) {
            if (a = a || 0, this.scrollTo(a, this.maxScrollY, b, this.options.bounceEasing), !this.loading) {
                this.pulldown !== !1 && this._initPullupRefresh(),
        ...
        endPullupToRefresh: function(a) {
            this.bottomPocket && (this.loading = !1, this._setCaption(this.options.up.contentdown), a && (this.bottomPocket.classList.add(n), this.wrapper.removeEventListener("scrollbottom", this)))
        },
        refresh: function(a) {
            if (a) {
                var b = this.bottomPocket.classList;
                b.contains(n) && (b.remove(n), this.wrapper.addEventListener("scrollbottom", this))
            }
            this._super()
        }
    });
    a.fn.pullRefresh = function(b) {
        if (1 === this.length) {
            ...
            return e ? d = a.data[e] : (e = ++a.uuid, a.data[e] = d = new t(c, b), c.setAttribute("data-pullrefresh", e)),
            d
        }
    }
} (mui, window, document),
function(a, b) {
    ...
    m = a.Scroll.extend({
        ...
        _init: function() {
            this.scroller = this.wrapper.querySelector("." + d),
            this.scrollerStyle = this.scroller.style,
            this.progressBar = this.wrapper.querySelector(l),
            this.progressBar && (this.progressBarWidth = this.progressBar.offsetWidth, this.progressBarStyle = this.progressBar.style),
            this.x = this._getScroll(),
            this.options.startX === !1 && (this.options.startX = this.x),
            this._super(),
            this._initTimer()
        },
        _initEvent: function() {
            ...
            function() {
                b.slideNumber = b._getSlideNumber();
                var c = b.slideNumber;
                b.loop && (0 === b.slideNumber ? (b.slideNumber = b.itemLength - 2, b.setTranslate( - b.wrapperWidth * (b.itemLength - 2), 0)) : b.slideNumber === b.itemLength - 1 && (b.slideNumber = 1, b.setTranslate( - b.wrapperWidth, 0)), c = b.slideNumber - 1),
            ...
            function(a) {
                ...
                var d = b.wrapper.querySelectorAll(".mui-slider-indicator .mui-indicator");
                if (d.length > 0) for (var e = 0,
                f = d.length; f > e; e++) d[e].classList[e === c.slideNumber ? "add": "remove"]("mui-active");
                else {
                    var g = b.wrapper.querySelector(".mui-slider-indicator .mui-number span");
                    if (g) g.innerText = c.slideNumber + 1;
                    else for (var h = b.wrapper.querySelectorAll(".mui-control-item"), e = 0, f = h.length; f > e; e++) h[e].classList[e === c.slideNumber ? "add": "remove"]("mui-active")
                }
                a.stopPropagation()
            }),
        ...
        _reLayout: function() {
            ...
            this.itemLength = this.scroller.querySelectorAll(j).length,
        ...
        _flick: function(a) {
            ...
            "up" === c || "down" === c ? void this.resetPosition(this.options.bounceTime) : ("flick" === a.type ? (this.x = -(this.slideNumber + ("left" === c ? 1 : -1)) * this.wrapperWidth, this.resetPosition(this.options.bounceTime)) : "dragend" !== a.type || b.flick || this.resetPosition(this.options.bounceTime), void a.stopPropagation())
        },
        _gotoItem: function(b, c) {
            this.scrollTo( - b * this.wrapperWidth, 0, c, this.options.bounceEasing),
            0 === c && a.trigger(this.wrapper, "scrollend", this),
            this._initTimer()
        },
        _fixedSlideNumber: function(a) {
            return this.loop || (0 > a ? a = 0 : a >= this.itemLength && (a = this.itemLength - 1)),
            a
        },
        setTranslate: function(a, b) {
            this._super(a, b);
        ...
        resetPosition: function(a) {
            ...
            this._gotoItem(this._getSlideNumber(), a),
            !0
        },
        ...
        nextItem: function(a) {
            ...
            a && !this.loop && this.slideNumber + 1 >= this.itemLength && (c = b = 0),
            this._gotoItem(b, c)
        },
        prevItem: function() {
...
function(a, b) {
    if (a.os.plus && a.os.android) {
        ...
        i = function(b) {
            b = a.extend(h, b, !0),
            this.downOptions = b.down,
            this.upOptions = b.up,
            this.downOptions && this.downOptions.hasOwnProperty("callback") && this.initPulldownRefresh(),
            this.upOptions && this.upOptions.hasOwnProperty("callback") && this.initPullupRefresh()
        };
        i.prototype.initPulldownRefresh = function() {
            var b = this,
            c = a.currentWebview;
            c.setPullToRefresh({
                support: !0,
                height: b.downOptions.height + "px",
                range: "200px",
                contentdown: {
                    caption: b.downOptions.contentdown
                },
                contentover: {
                    caption: b.downOptions.contentover
                },
                contentrefresh: {
                    caption: b.downOptions.contentrefresh
                }
            },
            function() {
                b.downOptions.callback && b.downOptions.callback.call(b)
            })
        },
        i.prototype.initPullupRefresh = function() {
            var c = this,
            d = b.querySelector(g);
            d && (c.bottomPocket = b.createElement("div"), c.bottomPocket.className = a.classNamePrefix + "pull-bottom-pocket", c.bottomPocket.innerHTML = '<div class="' + a.classNamePrefix + 'pull"><div class="' + a.classNamePrefix + "pull-loading " + a.classNamePrefix + "icon " + a.classNamePrefix + "icon-spinner-cycle " + a.classNamePrefix + 'spin"></div><div class="' + a.classNamePrefix + 'pull-caption">' + c.upOptions.contentdown + "</div></div>", d.appendChild(c.bottomPocket), c.pullLoading = c.bottomPocket.querySelector(".mui-pull-loading"), c.pullCaption = c.bottomPocket.querySelector(".mui-pull-caption"), c.isLoading = !1, b.addEventListener("plusscrollbottom", c))
        },
        i.prototype.handleEvent = function(a) {
            "plusscrollbottom" === a.type && this.pullupLoading()
        },
        i.prototype.endPulldownToRefresh = function() {
            a.currentWebview.endPullToRefresh()
        },
        i.prototype.pullupLoading = function() {
            var a = this;
            a.isLoading || (a.isLoading = !0, setTimeout(function() {
                a.pullLoading.classList.add(e),
                a.pullCaption.innerHTML = "",
                a.pullCaption.innerHTML = a.upOptions.contentrefresh;
                var b = a.upOptions.callback;
                b && b.call(a)
            },
            300))
        },
        i.prototype.endPullupToRefresh = function(a) {
            this.pullLoading && (this.pullLoading.classList.remove(e), this.pullCaption.innerHTML = this.upOptions.contentdown, this.isLoading = !1, a && (this.bottomPocket.classList.add(f), b.removeEventListener("plusscrollbottom", this)))
        },
        i.prototype.refresh = function(a) {
            if (a) {
                var c = this.bottomPocket.classList;
                c.contains(f) && (c.remove(f), b.addEventListener("plusscrollbottom", this))
            }
        },
        a.fn.pullRefresh = function(d) {
            if (1 === this.length) {
                var e = this[0],
                f = null,
                g = e.getAttribute("data-pullrefresh-plus");
                return g ? f = a.data[g] : (b.body.classList.add(c), g = ++a.uuid, a.data[g] = f = new i(d), e.setAttribute("data-pullrefresh-plus", g)),
                f
            }
        }
    }
...
function(a, b, c, d) {
    ...
    o = function(b, d) {
        if (d.classList && d.classList.contains(g)) {
            var e = n(d);
            if (e) return a.targets._container = e,
            d
    ...
    q = function() {
        ...
        a.classList.contains(k) || a.classList.contains(j) || p(a, !1)
    },
    r = function(a, b) {
        if (a && b) {
            var c = b.classList;
            a.querySelector(m).addEventListener("webkitTransitionEnd", q),
            a.classList.contains(k) || a.classList.contains(j) || p(a, !0),
            c.contains(e) ? a.classList.toggle(k) : c.contains(f) ? a.classList.toggle(j) : c.contains(g) && (a.classList.remove(k), a.classList.remove(j)),
            a.classList.add(l)
        }
    };
    b.addEventListener("tap",
...
function(a, b, c) {
    if (!a.os.android) {
        ...
        x = 0,
        y = function() {
            u !== v && (e.style["-webkit-transition-duration"] = "0s", "right" === g && u > 0 ? (u = Math.min(u, x), 0 > w ? z(e, w + u) : z(e, u)) : "left" === g && 0 > u && (u = Math.max(u, -x), w > 0 ? z(e, w + u) : z(e, u)), v = u),
        ...
        B = function() {
            ...
            b = a.classList;
            b.remove(n),
            this.removeEventListener("webkitTransitionEnd", B),
            b.contains(m) || b.contains(l) || A(a, !1)
        };
        b.addEventListener("touchstart",
        function(a) {
            var b = a.target;
        ...
        function(b) {
            if (d) {
                ...
                if ("left" === c.direction ? d.classList.contains(m) ? s = !0 : d.querySelector(r) && !d.classList.contains(l) && (s = !0) : "right" === c.direction && (d.classList.contains(l) ? s = !0 : d.querySelector(q) && !d.classList.contains(m) && (s = !0)), s) {
                    ...
                    var i = d.classList;
                    i.add(n),
                    i.contains(m) || i.contains(l) || A(d, !0),
        ...
        function() {
            if (s) {
                ...
                e.addEventListener("webkitTransitionEnd", B);
                var a, b = d.classList,
                c = ["add", "remove"];
...
function(a, b, c, d) {
    var e = "mui-action",
    f = function(a, b) {
        return b.className && ~b.className.indexOf(e) ? b: !1
    };
    a.registerTarget({
        name: d,
        index: 50,
...
function(a, b, c, d) {
    ...
    h = "mui-backdrop",
    i = "mui-bar-backdrop",
    j = "mui-backdrop-action",
    k = "mui-active",
    l = function(b, d) {
        return "A" === d.tagName && d.hash && (a.targets._popover = c.getElementById(d.hash.replace("#", "")), a.targets._popover && a.targets._popover.classList.contains(e)) ? (b.preventDefault(), d) : !1
    };
    a.registerTarget({
        name: d,
        index: 60,
    ...
    var m = function(a) {
        a ? c.body.setAttribute("style", "position:fixed;width:100%;height:100%;overflow:hidden;") : c.body.setAttribute("style", "")
    },
    n = function() {
        this.style.display = "none",
        this.removeEventListener("webkitTransitionEnd", n),
        m(!1)
    },
    o = function() {
        var b = c.createElement("div");
        ...
        function() {
            ...
            b && (b.addEventListener("webkitTransitionEnd", n), b.classList.remove(k), p(b))
        }),
        b
    } (),
    p = function(a) {
        ...
        setTimeout(function() {
            o.parentNode && o.parentNode === a.parentNode && a.parentNode.removeChild(o)
        },
        350)
    };
    b.addEventListener("tap",
    function() {
        a.targets.popover && q(a.targets._popover, a.targets.popover)
    });
    var q = function(a, d) {
        o.classList.remove(i),
        o.classList.remove(j);
        var e = c.querySelector(".mui-popover.mui-active");
        if (!e || (e.style.display = "none", e.classList.remove(k), e.removeEventListener("webkitTransitionEnd", n), m(!1), p(e), a !== e)) {
            if (a.classList.contains(f) || a.classList.contains(g)) if (a.classList.contains(g)) o.classList.add(j);
            else if (o.classList.add(i), d && d.parentNode) {
                var h = d.offsetWidth,
                l = d.offsetLeft,
                q = b.innerWidth;
                a.style.left = Math.min(Math.max(l, 5), q - h - 5) + "px"
            }
    ...
    a.fn.popover = function() {
        ...
        this.each(function() {
            ...
            ("show" === b[0] || "hide" === b[0] || "toggle" === b[0]) && q(this, b[1])
        })
    }
...
function(a, b, c, d) {
    ...
    function(b) {
        ...
        if (e) {
            ...
            k = "." + j;
            g = e.parentNode.querySelector(k),
            g && g.classList.remove(j);
            var l = e === g;
            if (e && e.classList.add(j), e.hash && (i = c.getElementById(e.hash.replace("#", "")))) {
                ...
                if (!l) {
                    h = i.parentNode.getElementsByClassName(j);
                    for (var m = 0; m < h.length; m++) h[m].classList.remove(j);
                    i.classList.add(j);
                    var n = i.parentNode.querySelectorAll("." + f);
                    a.trigger(i, a.eventName("shown", d), {
                        tabNumber: Array.prototype.indexOf.call(n, i)
                    }),
...
function(a, b, c, d) {
    ...
    h = "." + f,
    i = function(a, b) {
        return b.classList && b.classList.contains(e) ? b: !1
    };
    a.registerTarget({
        name: d,
        index: 100,
    ...
    var j, i, k, l, m, n = function(b) {
        if (j) {
            var c = b.detail;
            a.gestures.stoped = !0;
            var d = !c.drag && !j.classList.contains(g) || c.drag && c.deltaX > k / 2 - l / 2;
            i.style["-webkit-transition-duration"] = ".2s",
            d ? (i.style.webkitTransform = "translate3d(" + m + "px,0,0)", j.classList.add(g)) : (i.style.webkitTransform = "translate3d(0,0,0)", j.classList.remove(g)),
            a.trigger(j, "toggle", {
                isActive: d
            }),
            j.removeEventListener("dragstart", a.stopPropagation),
            j.removeEventListener("swiperight", a.stopPropagation),
            b.stopPropagation()
        }
    },
    o = function(a) {
        if (j) {
            ...
            if (0 > b) return i.style.webkitTransform = "translate3d(0,0,0)";
            if (b > m) return i.style.webkitTransform = "translate3d(" + m + "px,0,0)";
            i.style["-webkit-transition-duration"] = "0s",
            i.style.webkitTransform = "translate3d(" + b + "px,0,0)",
            j.classList[b > k / 2 - l / 2 ? "add": "remove"](g),
            a.stopPropagation()
        }
    };
    ...
    function(b) {
        j = a.targets.toggle,
        j && (j.addEventListener("dragstart", a.stopPropagation), j.addEventListener("swiperight", a.stopPropagation), i = j.querySelector(h), k = j.clientWidth, l = i.clientWidth, m = k - l + 3, b.preventDefault())
    }),
    b.addEventListener("tap", n),
    b.addEventListener("drag", o),
    b.addEventListener("dragend", n)
...
function(a, b, c) {
    ...
    var e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v = "mui-active",
    w = "mui-selected",
    x = "mui-grid-view",
    y = "mui-table-view-cell",
    z = "mui-collapse-content",
    A = "mui-disabled",
    B = "mui-switch",
    C = "mui-btn",
    D = "mui-slider-cell",
    ...
    O = 1,
    P = function(a) {
        a ? f ? f.classList.add(v) : e && e.classList.add(v) : f ? f.classList.remove(v) : e && e.classList.remove(v)
    },
    Q = function() {
        t !== u && (l || o ? (l && o ? 0 === i ? R(h, t) : R(h, i + t) : l ? 0 === i ? R(h, Math.max(t, 0)) : R(h, Math.max(i + t, 0)) : o && (0 === i ? R(h, Math.min(t, 0)) : R(h, Math.min(i + t, 0))), l && (0 === i ? t > n && (g.style.backgroundColor = m, R(l, Math.max(t - n, 0))) : (g.style.backgroundColor = t > 0 ? m: "", R(l, Math.max(t, 0)))), o && (0 === i ? -t > q && (g.style.backgroundColor = p, R(o, Math.min( - ( - t - q), 0))) : (g.style.backgroundColor = t > 0 && !l ? "": p, R(o, Math.min(t, 0))))) : h && (0 === i && t > 0 || i === j && 0 > t) && Math.abs(t) <= j && R(h, i + t), u = t),
    ...
    S = function(b, c) {
        l && (l.setAttribute("style", ""), o && o.setAttribute("style", ""), b ? (R(h, n), c && a.trigger(h, "slideright"), e.classList.add(w)) : (R(h, 0), e.classList.remove(w)))
    },
    T = function(b, c) {
        o && (o.setAttribute("style", ""), l && l.setAttribute("style", ""), b ? (R(h, -q), c && a.trigger(h, "slideleft"), e.classList.add(w)) : (R(h, 0), e.classList.remove(w)))
    },
    U = function(a) {
        h && (a ? (R(h, 0), e.classList.add(w)) : (R(h, j), e.classList.remove(w)))
    },
    V = function(b, c) {
        r = !1,
        ...
        var d = Math.abs(t);
        if (b || !l && !o) l || o || U(0 === i ? !(d > j / 2) : d > j / 2);
        else if (t > 0) {
            var e = n / 2;
            if (0 !== i && o && (T(!(d >= q / 2), !1), e = n / 2 + q), l) {
                var f = d >= e;
                l.classList.contains(H) ? (l.setAttribute("style", ""), R(h, 0), f && !c.swipe && a.trigger(h, "slideright")) : S(f, !0)
            }
        } else {
            var e = n / 2;
            if (0 !== i && l && (S(!(d >= n / 2), !1), e = q / 2 + n), o) {
                var f = d >= e;
                o.classList.contains(H) ? (o.setAttribute("style", ""), R(h, 0), f && !c.swipe && a.trigger(h, "slideleft")) : T(f, !0)
            }
        }
    };
    b.addEventListener("touchstart",
    function(b) {
        ...
        m = p = "";
        for (var v = b.target,
        D = !1; v && v !== c; v = v.parentNode) if (v.classList) {
            var E = v.classList;
            if (("INPUT" === v.tagName && "radio" !== v.type && "checkbox" !== v.type || "BUTTON" === v.tagName || E.contains(B) || E.contains(C) || E.contains(A)) && (D = !0), E.contains(z)) break;
            if (E.contains(y)) {
                e = v;
                var F = e.parentNode.querySelector("." + w);
                if (F && F != e) {
                    F.classList.remove(w);
                    var G = F.querySelector(J);
                    if (G) {
                        var H = F.querySelector(K);
                        H && H.setAttribute("style", "");
                        var Q = F.querySelector(L);
                        Q && Q.setAttribute("style", ""),
                        H || Q ? R(G, 0) : R(G, G.offsetWidth)
                    }
                }
                if (!e.parentNode.classList.contains(x)) {
                    var S = e.querySelector("a");
                    S && S.parentNode === e && (f = S)
                }
                if (g = e.querySelector(I), g && g.parentNode === e) {
                    var T = g.querySelector(J);
                    if (T) {
                        d(e),
                        h = T,
                        j = h.offsetWidth,
                        k = a.getStyles(h, "margin-left"),
                        O = N;
                        var U = g.querySelector(K);
                        U && (l = U, m = a.getStyles(U, "background-color"), n = U.offsetWidth);
                        var V = g.querySelector(L);
                        V && (o = V, p = a.getStyles(V, "background-color"), q = V.offsetWidth),
                        (l || o) && (O = M);
                        var W = a.getStyles(h, "webkitTransform"),
                        X = a.parseTranslateMatrix(W);
                        i = X ? X.x: 0
                    }
                }
                D || P(!0);
    ...
    var W = {
        ...
        drag: function(a) {
            r && (s || Q(), t = a.detail.deltaX * O, a.detail.gesture.preventDefault())
        },
        dragend: function(a) {
            r && V(!1, a.detail)
        },
        swiperight: function(b) {
            var c = !1;
            l && !l.classList.contains(H) && 0 === i ? (S(!0, !0), c = !0) : o && 0 > i ? (T(!1, !1), c = !0) : l || o || (c = !0),
            c && (a.gestures.stoped = !0, V(!0, b.detail)),
            b.stopPropagation()
        },
        swipeleft: function(b) {
            var c = !1;
            o && !o.classList.contains(H) && 0 === i ? (T(!0, !0), c = !0) : l && i > 0 ? (S(!1, !1), c = !0) : l || o || (c = !0),
            c && (a.gestures.stoped = !0, V(!0, b.detail)),
            b.stopPropagation()
        }
    };
    ...
    function(b) {
        if (e) {
            var c = !1,
            d = e.classList;
            if (d.contains("mui-collapse")) {
                if (b.detail.gesture.preventDefault(), !d.contains(v)) {
...
function(a, b, c) {
    ...
    r.prototype.initAction = function() {
        var a = this,
        b = a.element.parentNode;
        b && (a.sliderActionClass ? a.sliderAction = a.createAction(b, a.sliderActionClass, a.sliderActionSelector) : (a.searchActionClass && (a.searchAction = a.createAction(b, a.searchActionClass, a.searchActionSelector), a.searchAction.addEventListener("tap",
        function(b) {
            setTimeout(function() {
                a.element.focus()
            },
            10),
            b.stopPropagation()
        })), a.speechActionClass && (a.speechAction = a.createAction(b, a.speechActionClass, a.speechActionSelector), a.speechAction.addEventListener("click",
        function(a) {
            a.stopPropagation()
        }), a.speechAction.addEventListener("tap",
        function(b) {
            a.speechActionClick(b)
        })), a.clearActionClass && (a.clearAction = a.createAction(b, a.clearActionClass, a.clearActionSelector), a.clearAction.addEventListener("tap",
        function(b) {
            a.clearActionClick(b)
        }))))
    },
