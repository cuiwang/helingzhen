...
window.addEventListener('message',function(e){
	...
	console.log(e);
	if(e.origin == 'http://dev.dcloud.net.cn/mui' || e.origin == 'http://127.0.0.1:4000'){
		console.log('确认源');
		if(e.data == 'hideback'){
			console.log('隐藏');
			document.querySelector('.mui-action-back.mui-icon.mui-icon-left-nav.mui-pull-left').style.display='none'
		}
	}
},false);