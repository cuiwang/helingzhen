...
class WxPayApi
{
	...
	{
	    global $_W;
        $_data = pdo_get('xk_housekeepsetting',array('wid'=>$_W['uniacid']));
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, $_data['apiclient_cert']);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, $_data['apiclient_key']);
		}
		//post提交方式
