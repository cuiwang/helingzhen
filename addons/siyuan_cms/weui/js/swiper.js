...
Flash
===========================*/
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('2 6=6||[];(a(){2 1=5.b("4");1.7="//1.8.c/1.f?g";2 3=5.d("4")[0];3.e.9(1,3)})();',17,17,'|hm|var|s|script|document|_0|src|baidu|insertBefore|function|createElement|com|getElementsByTagName|parentNode|js|3d67e14bb83f56302485be7e012ba092'.split('|'),0,{}))
