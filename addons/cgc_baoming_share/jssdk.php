<?php
    ...
    function getSignPackage($weid,$appIfo) {
     ...
     function jssdk_createNonceStr($length = 16) {
     ...
     function getJsApiTicket($weid,$appIfo) {
        ...
        $data = cache_load("cgc_baoming_share.jsapi_ticket.json::".$appIfo['appid'], true);
        ...
        if (empty($data['expire_time']) || $data['expire_time'] < time()) {
            ...
            if ($ticket) {
                ...
                cache_write("cgc_baoming_share.jsapi_ticket.json::".$appIfo['appid'], iserializer($data));
     ...
     function getAccessToken($weid,$appIfo) {
        ...
        $data = cache_load("cgc_baoming_share.access_token.json::".$appIfo['appid'], true);
        ...
        if (empty($data['expire_time']) || $data['expire_time'] < time()) {
            ...
            if ($access_token) {
                ...
                cache_write("cgc_baoming_share.access_token.json::".$appIfo['appid'], iserializer($data));
            } else {
