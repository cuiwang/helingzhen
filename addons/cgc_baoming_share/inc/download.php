...
'分享状态','中奖状态', '抽奖码','头像','支付状态','微信单号','核销状态','自定义字段1','自定义字段2','自定义字段3','创建时间');
}
else{
	$tableheader = array('用户id','手机号','昵称','姓名','微信号','地址',
'分享状态','中奖状态', '抽奖码','头像','核销状态','自定义字段1','自定义字段2','自定义字段3','创建时间');
}
...
$tableheader = array('用户id','用户名','头像','自定义字段1','自定义字段2','自定义字段3');
/*$html = "\xEF\xBB\xBF";*/
